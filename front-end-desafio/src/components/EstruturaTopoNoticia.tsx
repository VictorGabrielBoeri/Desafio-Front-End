  ...
  return (
    <>
      ...
      <header className="d-grid align-items-start p-sm-3 px-sm-4 padding-resp" style={{ padding: '30px 100px 30px 100px' }}>
        <img className='img-fluid position-absolute top-0 start-0 w-100 h-154vh-resp' src="/img/topo/Rectangle-4.png" alt="" style={{ height: '120px', zIndex: '-11' }} />
        ...
        <div className="d-flex justify-content-between align-items-start mb-5 flex-wrap w-100-resp">
          ...
          <div className="d-flex justify-content-end align-items-center gap-5 flex-wrap">
            <nav className="navbar navbar-expand-lg navbar-light d-flex justify-content-end">
              <button className="navbar-toggler btn btn-sm btn-primary" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded={navAberta ? "true" : "false"} aria-label="Alternar navegação" onClick={alternarNav}>
