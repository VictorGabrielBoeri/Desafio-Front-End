            ...
            <div className="d-grid align-items-start" style={{ padding: '0px !important' }}>
                ...
                <div className="padding-resp" style={{ padding: '100px 100px 100px 100px' }}>
                    ...
                    <div className="position-relative">
                        <Image
                            className='img-fluid img-ADOBESTOCK-1-resp position-absolute top-0 rounded-2 img-ADOBESTOCK-resp-pc'
                            src="/img/secao/ADOBESTOCK_341268584-1.png"
                            alt="Stock Image"
                            width={382}
                            height={480}
                            style={{ zIndex: '10', left: '740px' }}
                        />
                        <Image
                            className='img-fluid img-Mask-group-database-resp position-absolute img-Mask-group-database-resp-pc'
                            src="/img/secao/Mask-group-database.png"
                            alt="Database Image"
                            width={381}
                            height={480}
                            style={{ zIndex: '10', top: '140px', left: '1165px' }}
                        />
                        <Image
                            className='img-fluid img-vector-1270-resp position-absolute img-vector-1270-resp-pc'
                            src="/img/secao/Vector-1270.png"
                            alt="Vector 1270"
                            width={149}
                            height={55}
                            style={{ zIndex: '10', left: '905px', top: '580px' }}
                        />
                        <Image
                            className='img-fluid img-vector-1271-resp position-absolute img-vector-1271-resp-pc'
                            src="/img/secao/Vector-1271.png"
                            alt="Vector 1271"
                            width={149}
                            height={55}
                            style={{ zIndex: '10', left: '1210px', top: '40px' }}
                        />
                        <Image
                            className='img-fluid img-tag-resp position-absolute img-tag-resp-pc'
                            src="/img/secao/tag.png"
                            alt="Tag Image"
                            width={260}
                            height={38}
                            style={{ zIndex: '10', left: '678px', top: '438px' }}
                        />
                    </div>
